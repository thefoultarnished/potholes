  ...
  >
    ...
    <div class="relative z-10 flex flex-col items-center">
      ...
      <div class="relative mb-8 w-24 h-24 flex items-center justify-center">
        <div class="w-full h-full" in:scale={{ duration: 500, delay: 100 }}>
          <!-- Ping effect -->
          <div 
      ...
      <!-- Title -->
      <div class="text-center min-h-[3.5rem] flex flex-col justify-end" in:fade={{ duration: 500, delay: 200 }}>
