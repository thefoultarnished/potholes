  ...
  >
    ...
    <div class="absolute inset-0 {darkMode ? 'bg-[#02040a]' : 'bg-gradient-to-br from-[#e4e4e7] via-[#f1f5f9] to-[#e2e8f0]'}">
      <div class="absolute inset-0 overflow-hidden">
        <div class="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full blur-[100px] {darkMode ? 'bg-cyan-900/40' : 'bg-cyan-300/70'}"></div>
        <div class="absolute -top-32 -right-20 w-[500px] h-[500px] rounded-full blur-[100px] {darkMode ? 'bg-blue-900/40' : 'bg-cyan-300/70'}"></div>
        <div class="absolute -bottom-40 -right-40 w-[600px] h-[600px] rounded-full blur-[100px] {darkMode ? 'bg-indigo-900/40' : 'bg-blue-300/80'}"></div>
      </div>
    </div>
    ...
    <div class="relative z-10 flex flex-col items-center">
      ...
      <div class="relative mb-8" in:scale={{ duration: 500, delay: 100 }}>
        <!-- Ping effect -->
        <div 
          class="absolute inset-0 rounded-full animate-ping opacity-20 {darkMode ? 'bg-cyan-400' : 'bg-cyan-500'}"
        ...
        <div class="relative w-24 h-24 rounded-full flex items-center justify-center backdrop-blur-xl
          ...
          <img 
            ...
            style={darkMode ? 'filter: invert(78%) sepia(44%) saturate(2099%) hue-rotate(147deg) brightness(101%) contrast(101%);' : ''}
          />
        </div>
      </div>
      ...
      <div class="text-center" in:fade={{ duration: 500, delay: 200 }}>
        ...
        <div class="flex items-center justify-center gap-1">
          {#each [0, 1, 2] as i}
            <div 
              class="w-2 h-2 rounded-full {darkMode ? 'bg-cyan-400' : 'bg-cyan-500'} animate-pulse"
