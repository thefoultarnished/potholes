...
<div
  ...
  class="rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 group/tile relative
    {darkMode 
  ...
  style={darkMode ? `
    background: 
      linear-gradient(180deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0) 50%, rgba(255, 255, 255, 0.01) 100%),
      rgba(255, 255, 255, 0.01);
    border: 1px solid rgba(255, 255, 255, 0.06);
    box-shadow: 
      0px 4px 24px -1px rgba(0, 0, 0, 0.4), 
...
>
  ...
  <div class="aspect-square relative overflow-hidden rounded-t-3xl" on:click={() => onSelect(data)} on:keypress={() => onSelect(data)} role="button" tabindex="0">
    ...
    />
    <div class="absolute top-3 left-3 text-white text-[10px] uppercase tracking-wider font-bold px-3 py-1 rounded-full backdrop-blur-md shadow-lg {sizeInfo.color} bg-opacity-90 border border-white/20">
      {sizeInfo.label}
    </div>
  </div>
